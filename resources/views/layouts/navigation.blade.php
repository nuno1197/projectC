    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <!-- Navigation Links -->
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex text-rich_black font-extrabold dark:text-white ">
                        <x-nav-link :href="route('landing')" :active="request()->is('planning*') || request()->is('roster*') || request()->is('plangame*')">
                            {{ __('My Team') }}
                        </x-nav-link>

                        <x-nav-link :href="route('drill.menu')" :active="request()->routeIs('drill*')">
                            {{ __('Drills') }}
                        </x-nav-link>
                    </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 ml-15 ">
                ...
                @auth
                    <!-- Code block starts -->
                    <div class=" flex focus:outline-none h-10 w-10 mb-2 mt-2 lg:mb-2 ml-auto float-right">
                        <img src="{{Vite::asset('/resources/images/icons/'.Auth::user()->icon_choosed.".png")}}" alt="man avatar" class="h-full w-full rounded-full overflow-hidden shadow" />
                    </div>
                @endauth
