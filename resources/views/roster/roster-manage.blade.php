<x-app-layout>
    ...
    <div class="flex justify-center">
        <div class="grid grid-cols-4 gap-8">
            ...
            <x-menu.menu-button address="{{route('events.index', ['roster' => $roster->id])}}" imgsrc="{{Vite::asset('/resources/images/buttons/blueprint_menu.jpg')}}" imgClass="w-full h-full object-cover" spanClass="text-flax text-4xl font-extrabold">Practices Menu</x-menu.menu-button>
        </div>
    </div>
</x-app-layout>
