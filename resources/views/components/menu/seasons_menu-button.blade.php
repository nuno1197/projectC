<a href="{{$address}}"
   class=" mr-4 group relative overflow-hidden w-64 h-40 bg-rich_black border border-gray-400 rounded-lg transition transform hover:scale-110 flex items-center justify-center">
